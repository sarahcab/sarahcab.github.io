...
//////////////////requête principale
	$sql = "select ".$lsvar.",x,y,st_astext(geom) from nuts where st_intersects(ST_GeomFromText('POLYGON((".floatval($ymin)." ".floatval($xmin).",".floatval($ymax)." ".floatval($xmin).",".floatval($ymax)." ".floatval($xmax).",".floatval($ymin)." ".floatval($xmax).",".floatval($ymin)." ".floatval($xmin)."))','4326'),geom)";
