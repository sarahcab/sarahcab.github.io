...
for row in f :
    ...
    if lsvals[5] == "" :
        ...
        cur.execute('''
INSERT INTO chemineur (nomPerso,prenom,nomStru,objet,territoire,cheminees,actions,agenda,envieProp,mail,tel,adresse,codePost,commune,site) VALUES (%(nomPerso)s,%(prenom)s,%(nomStru)s,%(objet)s,%(territoire)s,%(cheminees)s,%(actions)s,%(agenda)s,%(envieProp)s,%(mail)s,%(tel)s,%(adresse)s,%(codePost)s,%(commune)s,%(site)s)
        ...
        for g in fet :
            geom = str(g).split("'")[1]
        cur.execute('''
INSERT INTO chemineur (nomPerso,prenom,nomStru,objet,territoire,cheminees,actions,agenda,envieProp,mail,tel,adresse,codePost,commune,site,geom) VALUES (%(nomPerso)s,%(prenom)s,%(nomStru)s,%(objet)s,%(territoire)s,%(cheminees)s,%(actions)s,%(agenda)s,%(envieProp)s,%(mail)s,%(tel)s,%(adresse)s,%(codePost)s,%(commune)s,%(site)s,ST_GeomFromText(%(geom)s, %(srid)s))
