...
function demarrer(){
	d3.select("#bouton_l")
		.on("click",function(){
			...
			d3.select("#fleche").transition().delay(1700).duration(500).attr("transform","translate(0,300)").transition().attr("class","clignote")
			d3.select("#cible_caisson").attr("class","clignote")
			d3.select("#boutons").attr("class","clignote")
